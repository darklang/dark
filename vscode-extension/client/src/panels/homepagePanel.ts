...
export class HomepagePanel {
  ...
  private _handleNavigation(page: string) {
    ...
    const CallGraphPanel = require("./callGraphPanel").CallGraphPanel;
    ...
    switch (page) {
      case "approval-requests":
        ...
        break;
      case "call-graph":
        CallGraphPanel.createOrShow(this._extensionUri);
        break;
...
<rect width="8" height="8" fill="white"/>
            ...
            <div class="nav-item" data-page="call-graph">
                <span class="nav-icon"><svg xmlns="http://www.w3.org/2000/svg" width="6" height="6" viewBox="0 0 24 24" fill="none" stroke="#CACACA" stroke-width="2"><circle cx="12" cy="12" r="2"/><path d="M12 2v4m0 12v4M2 12h4m12 0h4"/></svg></span>
                <span class="nav-label">Call Graph</span>
            </div>
