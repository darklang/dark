...
export class CanvasElementsTreeProvider implements vscode.TreeDataProvider<CanvasItem>{
    constructor() { }
    ...
    getTreeItem(element: CanvasItem): vscode.TreeItem {
        if (element === undefined) {
            ...
            return new vscode.TreeItem(`${element.title} (${element.children.length})`, vscode.TreeItemCollapsibleState.Collapsed);
        } else {
            return new vscode.TreeItem(
                element.title,
