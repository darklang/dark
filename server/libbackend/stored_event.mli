...
val store_event : Uuid.t -> string -> event_desc -> Types.RuntimeT.dval -> unit
val load_events : Uuid.t -> string -> event_desc -> Types.RuntimeT.dval list
val list_events : Uuid.t -> string -> event_desc list
val clear_events : Uuid.t -> string -> unit
