    ...
    let
        t l r e =
            test (toString l ++ " <=> " ++ toString r)
                (\_ ->
                    if Util.listContainsOrdered l r == e then
                        Expect.pass
...
stringContainsOrdered =
    let
        t l r e =
            test (toString l ++ " <=> " ++ toString r)
                (\_ ->
                    if Util.stringContainsOrdered l r == e then
                        Expect.pass
...
uniqueCombinations =
    let
        t l r =
            test (toString l ++ " <=> " ++ toString r)
                (\_ ->
                    if Util.uniqueCombinations l == r then
                        Expect.pass

                    else
                        Expect.fail ("Expected: " ++ toString r ++ ", got: " ++ (l |> Util.uniqueCombinations |> toString))
                )
    in
