...
div vs configs content =
    let
        getFirst fn =
            configs |> List.filterMap fn |> List.head
        ...
        computedValueData =
            Maybe.andThen value computedValueAs

        hoverdata =
            Maybe.andThen value hoverAs
        ...
        classAttr =
            Attrs.class (String.join " " allClasses)
