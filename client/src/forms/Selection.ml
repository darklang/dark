...
let enterWithOffset (m : model) (tlid : TLID.t) (id : id) (offset : int option)
    : modification =
...
let enter (m : model) (tlid : TLID.t) (id : id) : modification =
  enterWithOffset m tlid id None


let dblclick (m : model) (tlid : TLID.t) (id : id) (offset : int option) :
    modification =
