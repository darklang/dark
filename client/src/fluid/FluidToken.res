...
let isAppendable = (t: t): bool =>
  ...
  | TString(_) | TMPString(_) | TStringMLEnd(_) => false
  | _ => isTextToken(t)
  }
...
let toCategoryName = (t: t): string =>
  ...
  | TMPTupleComma(_)
  | TMPTupleClose(_)
  | TMPFloatFractional(_) => "matchpattern"
...
let matchesContent = (t1: t, t2: t): bool =>
  ...
  | (TMPNull(p1, id1, ind1), TMPNull(p2, id2, ind2))
