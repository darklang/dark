...
let sampleFunctions: list<RT.BuiltInFn.t> = {
  ...
  list{
    ...
    },
    {
      ...
      parameters: list{par("list", TList(TVariable("x"))), par("index", TInt)},
    ...
    },
    {
      ...
      parameters: list{
        par("dict", TDict(TVariable("efg"))),
        par("f", TFn(list{TStr, TVariable("c")}, TVariable("a")), ~args=list{"key", "value"}),
      },
      returnType: TDict(TVariable("d")),
      description: "",
      previewable: Pure,
      deprecated: NotDeprecated,
      isInfix: false,
    ...
    },
    {
      ...
      parameters: list{
        par("val", TDict(TVariable("lmn"))),
        par("key", TStr),
        par("table", TDB(TVariable("x"))),
      },
      returnType: TDict(TVariable("x")),
      description: "",
      previewable: Impure,
      deprecated: NotDeprecated,
      isInfix: false,
...
let run = () => {
  describe("takeOffRail & putOnRail", () => {
    let f1: RT.BuiltInFn.t = {
      ...
      parameters: list{},
      description: "",
      returnType: TResult(TVariable("d"), TVariable("efg")),
      previewable: Pure,
      deprecated: NotDeprecated,
      isInfix: false,
      sqlSpec: NotQueryable,
