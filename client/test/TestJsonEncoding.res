...
let run = () => {
  ...
  describe("decode serializations", () => {
    ...
    let ignores = [
      ...
      "vanilla_ClientTypes-Pusher_ClientTypes-Pusher-Payload-AddOpV1PayloadTooBig_simple.json", // not used yet
      // Internal to backend
    ...
    t(
      "vanilla_ClientTypes-Pusher_ClientTypes-StaticDeploy-T_simple.json",
      StaticAssets.Deploy.decode,
      StaticAssets.Deploy.encode,
    )
    t(
      "vanilla_ClientTypes-Pusher_ClientTypes-Pusher-Payload-AddOpV1_simple.json",
