...
let run = () => {
  ...
  describe("Floats", () => {
    ...
    t("insert negative in whole - no whole", aFloatWithoutWhole, ~pos=0, ins("-"), "-~.1")
    t("insert negative in whole - start", aFloat, ~pos=0, ins("-"), "-~123.456")
    t("insert negative in whole - idx1", aFloat, ~pos=1, ins("-"), "1~23.456")
    t("insert negative in negative whole - start", negFloat, ~pos=0, ins("-"), "~-123.456")
    t("insert negative in negative whole - idx1", negFloat, ~pos=1, ins("-"), "-~123.456")
  ...
  describe("Constructors", () => {
    ...
    t(
      ...
      ~wrap=/* wrap false because else we delete the wrapper */ false,
      match'(b, list{(mpConstructor("Just", list{mpBlank()}), b)}),
      ~pos=0,
      inputs(list{keypress(K.SelectAll), DeleteContentBackward}),
      "~___",
    )
  ...
  describe("Lists", () => {
    ...
    t(
      ...
      match'(singleElementList, list{(mpBlank(), b)}),
      ~pos=9,
      ins(","),
      "match [56,~___]\n  *** -> ___\n",
    )
  ...
  describe("Tuples", () => {
    ...
    describe("insert", () => {
      ...
      t(
        ...
        match'(tuple2WithNoBlank, list{(mpBlank(), b)}),
