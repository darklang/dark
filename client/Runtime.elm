...
isInt : String -> Bool
isInt s =
    (String.toInt s |> Util.resultIsOk)
...
isFloat : String -> Bool
isFloat s =
    String.toFloat s |> Util.resultIsOk
...
tipeOf s =
    ...
    else if isChar s then
        TChar

    else if isBool s then
        TBool

    else if isNull s then
        TNull

    else if isNothing s then
        TOption
