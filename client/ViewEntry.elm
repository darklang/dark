...
stringEntryHtml ac width =
    let
        ...
        value =
            Util.transformToStringEntry ac.value
        ...
        sizeClass =
            if Autocomplete.isSmallStringEntry ac then
                "small-string"
...
entryHtml permission width placeholder ac =
    case permission of
        StringEntryAllowed ->
            if Autocomplete.isStringEntry ac then
                stringEntryHtml ac width
