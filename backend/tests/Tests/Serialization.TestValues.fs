...
let typeHash = PackageHashes.Type.Stdlib.option
let fnHash = PackageHashes.Fn.Stdlib.List.map
let valueHash =
  Hash "75ffeb0cc9436a9af08e370b0dc25453385007c6c3aeee3483fe2ed65af3285a" // Cli.Colors.accent
