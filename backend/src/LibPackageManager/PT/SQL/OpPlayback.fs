...
/// - rebrand LibSerialization as LibSerialization
...
///
/// Hm - although hacky, might be ... kinda reasonable for now?
/// a general strategy of: do binary write thing, then take hash of _that_.
