        ...
        | _, [ _typeParam ], [ DUnit ] ->
          uply {
            try
              ...
              return Dval.resultOk okType errType state
            with e ->
              return
      ...
      fn =
        ...
        | _, [ _typeParam ], [ v ] ->
          uply {
            ...
            return Dval.resultOk okType errType v
          }
        | _ -> incorrectArgs ())
      sqlSpec = NotQueryable
      previewable = Impure
    ...
    { name = fn "callJSFunction" 0
      ...
      fn =
        ...
        | _, _, [ DString functionName; DList(_, args) ] ->
          ...
          | Error err -> Ply(Dval.resultError okType errType (DString err))
        | _ -> incorrectArgs ())
      sqlSpec = NotQueryable
      previewable = Impure
      deprecated = NotDeprecated }
        ...
        | _, _, [ DString sourceJson ] ->
          uply {
            ...
            | DError(_source, rte) ->
              ...
              return Dval.resultError okType errType (DString(string rte))
            | result ->
              return
