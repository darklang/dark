...
module ParseError =
  ...
  let toDT (e : ParseError) : Dval =
    ...
    let typeName = FQTypeName.fqPackage PackageHashes.Type.Stdlib.int128ParseError
    ...
    { name = fn "int128Parse" 0
      ...
      returnType =
        TypeReference.result
          TInt128
          (TCustomType(
            Ok(FQTypeName.fqPackage PackageHashes.Type.Stdlib.int128ParseError),
            []
          ))
      description = "Returns the <type Int128> value of a <type String>"
      fn =
        let typeName =
          FQTypeName.fqPackage PackageHashes.Type.Stdlib.int128ParseError
