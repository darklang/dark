  ...
  [ { name = fn "uniqueBy" 0
    ...
    { name = fn "sortByComparator" 0
      ...
      fn =
        ...
        let resultError = Dval.checkedResultError okType VT.string
    ...
    { name = fn "append" 0
      ...
      fn =
        ...
        | _, _, [ DList(vt1, l1); DList(_vt2, l2) ] ->
          ...
          Ply(Dval.checkedList vt1 (List.append l1 l2))
        | _ -> incorrectArgs ())
      sqlSpec = NotYetImplemented
      previewable = Pure
      deprecated = NotDeprecated }
      ...
      fn =
        ...
        | state, _, [ DList(_, l); DFnVal b ] ->
          uply {
            ...
            return Dval.checkedList VT.unknownTODO result
          }
        | _ -> incorrectArgs ())
      sqlSpec = NotYetImplemented
      previewable = Pure
        ...
        | state, _, [ DList(_vtTODO1, l1); DList(_vtTODO2, l2); DFnVal b ] ->
          uply {
            if List.length l1 <> List.length l2 then
              return Dval.checkedOptionNone optType
            else
              let list = List.zip l1 l2
              ...
              return
                Dval.checkedList VT.unknownTODO result
                |> Dval.checkedOptionSome optType
          }
        | _ -> incorrectArgs ())
      sqlSpec = NotYetImplemented
      previewable = Pure
    ...
    { name = fn "randomElement" 0
      ...
      fn =
        let optType = VT.unknownTODO
        (function
        | _, _, [ DList(_, []) ] -> Dval.checkedOptionNone optType |> Ply
        | _, _, [ DList(_, l) ] ->
          ...
          (List.tryItem index l) |> Dval.checkedOption optType |> Ply
        | _ -> incorrectArgs ())
      sqlSpec = NotYetImplemented
      previewable = Impure
      deprecated = NotDeprecated }
