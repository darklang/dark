...
let fns : List<BuiltInFn> =
  [ { name = fn "singleton" 0
      ...
      fn =
        (function
        | _, _, [ v ] -> Ply(Dval.list valueTypeTODO [ v ])
        | _ -> incorrectArgs ())
    ...
    { name = fn "fold" 0
      ...
      fn =
        (function
        | state, _, [ DList(_vtTODO, l); init; DFnVal b ] ->
    ...
    { name = fn "interpose" 0
      ...
      fn =
        ...
        | _, _, [ DList(_vtTODO, l); i ] ->
          ...
          Ply(Dval.list valueTypeTODO (join l))
        | _ -> incorrectArgs ())
      sqlSpec = NotYetImplemented
      previewable = Pure
      deprecated = NotDeprecated }
    ...
    { name = fn "interleave" 0
      ...
      fn =
        (function
        | _, _, [ DList(_vtTODO1, l1); DList(_vtTODO2, l2) ] ->
          let rec f l1 l2 =
            match l1 with
            | [] -> l2
            | x :: xs ->
          ...
          Ply(Dval.list valueTypeTODO (f l1 l2))
        | _ -> incorrectArgs ())
      sqlSpec = NotYetImplemented
      previewable = Pure
      deprecated = NotDeprecated }
    ...
    { name = fn "sortBy" 0
      ...
      fn =
        (function
        | state, _, [ DList(_vtTODO, list); DFnVal b ] ->
          uply {
            try
              let fn dv =
                let args = NEList.singleton dv
    ...
    { name = fn "sortByComparator" 0
      ...
      fn =
        (function
        | state, _, [ DList(_vtTODO, list); DFnVal f ] ->
          ...
          uply {
            try
              ...
              return
                array |> Array.toList |> Dval.list valueTypeTODO |> Dval.resultOk
            with
    ...
    { name = fn "append" 0
      ...
      fn =
        (function
        | _, _, [ DList(_vtTODO1, l1); DList(_vtTODO2, l2) ] ->
          Ply(Dval.list valueTypeTODO (List.append l1 l2)) // no checking for DError required
        | _ -> incorrectArgs ())
      sqlSpec = NotYetImplemented
      previewable = Pure
      deprecated = NotDeprecated }
    ...
    { name = fn "unzip" 0
      ...
      fn =
        ...
        | _, _, [ DList(_vtTODO, l) ] ->
          ...
          match result with
          | (l, l2) ->
            Ply(DTuple(Dval.list valueTypeTODO l, Dval.list valueTypeTODO l2, []))
        | _ -> incorrectArgs ())
      sqlSpec = NotYetImplemented
      previewable = Pure
      deprecated = NotDeprecated }
    ...
    { name = fn "randomElement" 0
      ...
      fn =
        (function
        | _, _, [ DList(_vtTODO, []) ] -> Ply(Dval.optionNone)
        | _, _, [ DList(_vtTODO, l) ] ->
      ...
      fn =
        ...
        | state, _, [ DList(_vtTODO, l); DFnVal fn ] ->
          uply {
            ...
            | Ok(a, b) ->
              return DTuple(Dval.list valueTypeTODO a, Dval.list valueTypeTODO b, [])
