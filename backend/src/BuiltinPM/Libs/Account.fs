...
let fns : List<BuiltInFn> =
  [ { name = fn "scmGetCurrentAccountId" 0
      typeParams = []
    ...
    { name = fn "scmClearCurrentBranch" 0
      typeParams = []
      parameters = [ Param.make "" TUnit "" ]
      returnType = TUnit
