...
// Blob dereferencing is value materialization, including reads of persistent
// bytes from the host-owned blob store. It has no call effect; see
// docs/effects.md for the local-storage boundary and its limits.
