...
module private DarkTypes =
  ...
  let diagnosticCodeToDT (code : Checker.DiagnosticCode) : Dval =
    let caseName =
      ...
      | Checker.InvalidPropagation -> "InvalidPropagation"
  ...
  let private siteToDT (site : Checker.Site) : Dval =
    ...
    | Checker.PropagatedError -> make "PropagatedError" []
  ...
  let contextToDT (context : Checker.Context) : Dval =
    ...
    | Checker.PropagationReturnContainerMismatch ->
      make "PropagationReturnContainerMismatch" []
    | Checker.PropagationOutsideFunction -> make "PropagationOutsideFunction" []
    | Checker.PropagationRequiresOptionOrResult ->
      make "PropagationRequiresOptionOrResult" []
