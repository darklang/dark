...
type Context =
  ...
  // TODO remove this soon, in favor of a `DvalCreationError` error
  | RecordField of
...
type Error =
  ...
  | ValueNotExpectedType of
    ...
    // TODO There seems to be some redundancy between this expectedType and ones within the Context
    expectedType : TypeReference *
