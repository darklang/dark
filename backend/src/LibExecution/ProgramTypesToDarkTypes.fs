...
module FQTypeName =
  let knownType = KTCustomType(ptTyp [ "FQTypeName" ] "FQTypeName" 0, [])
...
module FQFnName =
  let knownType = KTCustomType(ptTyp [ "FQFnName" ] "FQFnName" 0, [])
...
module FQConstantName =
  let knownType = KTCustomType(ptTyp [ "FQConstantName" ] "FQConstantName" 0, [])
