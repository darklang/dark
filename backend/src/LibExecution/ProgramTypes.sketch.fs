...
type PackageOp =
  ...
  | SetTypeName of id: FQTypeName.Package * location: Location
  | SetValueNameof id: FQValueName.Package * location: Location
  | SetFnName of id: FQFnName.Package * location: Location
...
type PackageManager =
  { findType : Option<BranchID> * Location -> Ply<Option<FQTypeName.Package>>
    findValue : Option<BranchID> *  PackageValue.Name -> Ply<Option<FQValueName.Package>>
    findFn : Option<BranchID> *  PackageFn.Name -> Ply<Option<FQFnName.Package>>

    getType : Option<BranchID> *  FQTypeName.Package -> Ply<Option<PackageType.PackageType>>
    getValue : Option<BranchID> *  FQValueName.Package -> Ply<Option<PackageValue.PackageValue>>
    getFn : Option<BranchID> *  FQFnName.Package -> Ply<Option<PackageFn.PackageFn>>
...
module Patch =
  type T = {
    id: uuid
    title: string
    ops: List<Op.T> // order here matters
  }
