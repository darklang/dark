  ...
  module Unwraps =
    let toDT (e : RuntimeError.Unwraps.Error) : Dval =
      ...
      let (caseName, fields) =
        ...
        | RuntimeError.Unwraps.PropagationContainerMismatch actual ->
          "PropagationContainerMismatch", [ Dval.toDT actual ]
        | RuntimeError.Unwraps.PropagationOperandNotContainer actual ->
          "PropagationOperandNotContainer", [ Dval.toDT actual ]
    ...
    let fromDT (d : Dval) : RuntimeError.Unwraps.Error =
      ...
      | DEnum(_, _, [], "PropagationContainerMismatch", [ actual ]) ->
        RuntimeError.Unwraps.PropagationContainerMismatch(Dval.fromDT actual)
      | DEnum(_, _, [], "PropagationOperandNotContainer", [ actual ]) ->
        RuntimeError.Unwraps.PropagationOperandNotContainer(Dval.fromDT actual)
