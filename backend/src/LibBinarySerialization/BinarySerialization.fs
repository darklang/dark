  ...
  with e ->
    ...
    raise (
      Exception.InternalException(
        ...
        [ "id", id
          "suggestion", "check custom binary serializer implementation" ],
        e
      )
    )
  ...
  let serialize (pt : PT.PackageType.PackageType) : byte[] =
    wrapSerializationException (string pt.id) (fun () ->
      ...
      Primitives.Serialization.serializeWithHeader 
        ...
        (fun writer -> LibBinarySerialization.Binary.Serializers.PackageType.write writer serializableValue))
  ...
  let serialize (constant : PT.PackageConstant.PackageConstant) : byte[] =
    wrapSerializationException (string constant.id) (fun () ->
      ...
      Primitives.Serialization.serializeWithHeader 
        ...
        (fun writer -> LibBinarySerialization.Binary.Serializers.PackageConstant.write writer serializableValue))

  let deserialize (uuid : System.Guid) (data : byte[]) : PT.PackageConstant.PackageConstant =
    wrapSerializationException (string uuid) (fun () ->
      let deserializedST = 
        Primitives.Serialization.deserializeWithHeader 
  ...
  let serialize (fn : PT.PackageFn.PackageFn) : byte[] =
    wrapSerializationException (string fn.id) (fun () ->
      ...
      Primitives.Serialization.serializeWithHeader 
        ...
        (fun writer -> LibBinarySerialization.Binary.Serializers.PackageFn.write writer serializableValue))
  ...
  let serialize (tl : PT.Toplevel.T) : byte[] =
    wrapSerializationException (string (PT.Toplevel.toTLID tl)) (fun () ->
      ...
      Primitives.Serialization.serializeWithHeader 
        ...
        (fun writer -> LibBinarySerialization.Binary.Serializers.Toplevel.write writer serializableValue))
...
module Toplevels =
    ...
    wrapSerializationException msg (fun () ->
      ...
      Primitives.Serialization.serializeWithHeader 
        ...
        (fun writer -> 
          ...
          Primitives.Writer.writeList writer LibBinarySerialization.Binary.Serializers.Toplevel.write serializableValues))
  ...
  let deserialize (msg : string) (data : byte[]) : List<PT.Toplevel.T> =
    wrapSerializationException msg (fun () ->
      ...
      let deserializedSTs = Primitives.Reader.readList reader LibBinarySerialization.Binary.Serializers.Toplevel.read
