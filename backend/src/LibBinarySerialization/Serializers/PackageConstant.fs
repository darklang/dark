...
module LibBinarySerialization.Serializers.PackageConstant
...
let writeFQConstantName
  (writer : BinaryWriter)
  (name : FQConstantName.FQConstantName)
  : unit =
...
let write
  (writer : BinaryWriter)
  (packageConstant : PackageConstant.PackageConstant)
  : unit =
