...
and readInfix (reader : BinaryReader) : Infix = Infix.read reader
...
and writeNameResolutionFQConstantName
  (writer : BinaryWriter)
  (nameRes : NameResolution<FQConstantName.FQConstantName>)
  : unit =
...
and writeNEListLetPattern
  (writer : BinaryWriter)
  (pats : NEList<LetPattern>)
  : unit =
...
and writeNEListStringExpr
  (writer : BinaryWriter)
  (updates : NEList<string * Expr>)
  : unit =
...
and writeInfix (writer : BinaryWriter) (op : Infix) : unit = Infix.write writer op

and writeNameResolutionFQFnName
  (writer : BinaryWriter)
  (nameRes : NameResolution<FQFnName.FQFnName>)
  : unit =
