...
module Deprecation =
  let write (writer: BinaryWriter) (writeNameFn: BinaryWriter -> 'name -> unit) (deprecation: Deprecation<'name>) : unit =
  ...
  let read (reader: BinaryReader) (readNameFn: BinaryReader -> 'name) : Deprecation<'name> =
...
module TypeDeclaration =
  ...
  and writeDefinition (writer: BinaryWriter) (def: TypeDeclaration.Definition) : unit =
    match def with
  ...
  and writeRecordField (writer: BinaryWriter) (field: TypeDeclaration.RecordField) : unit =
    Writer.writeString writer field.name
    writeTypeReference writer field.typ
    Writer.writeString writer field.description

  and writeNEListRecordField (writer: BinaryWriter) (fields: NEList<TypeDeclaration.RecordField>) : unit =
    writeRecordField writer fields.head
    Writer.writeList writer writeRecordField fields.tail

  and writeEnumCase (writer: BinaryWriter) (case: TypeDeclaration.EnumCase) : unit =
  ...
  and writeEnumField (writer: BinaryWriter) (field: TypeDeclaration.EnumField) : unit =
    writeTypeReference writer field.typ
    Writer.writeOption writer Writer.writeString field.label
    Writer.writeString writer field.description

  and writeNEListEnumCase (writer: BinaryWriter) (cases: NEList<TypeDeclaration.EnumCase>) : unit =
  ...
  and readDefinition (reader: BinaryReader) : TypeDeclaration.Definition =
    ...
    | b -> raise (BinaryFormatException(CorruptedData $"Invalid TypeDeclaration.Definition tag: {b}"))
  ...
  and readNEListRecordField (reader: BinaryReader) : NEList<TypeDeclaration.RecordField> =
