...
let fns : List<BuiltInFn> =
  [ { name = fn "Math" "pi" 0
    ...
    { name = fn "Math" "degrees" 0
      ...
      returnType = TFloat
      description = "Returns the equivalent of `angleInDegrees` in radians, the unit used by all of Dark's trigonometry functions.
    ...
    { name = fn "Math" "turns" 0
      ...
      returnType = TFloat
      description = "Returns the equivalent of `angleInTurns` in radians, the unit used by all of Dark's trigonometry functions.
    ...
    { name = fn "Math" "radians" 0
      ...
      returnType = TFloat
      description = "Returns `angleInRadians` in radians, the unit used by all of Dark's trigonometry functions.
    ...
    { name = fn "Math" "cos" 0
      parameters = [ Param.make "angleInRadians" TFloat "" ]
      returnType = TFloat
      description = "Returns the cosine of the given `angleInRadians`.
    ...
    { name = fn "Math" "sin" 0
      parameters = [ Param.make "angleInRadians" TFloat "" ]
      returnType = TFloat
      description = "Returns the sine of the given `angleInRadians`.
    ...
    { name = fn "Math" "tan" 0
      parameters = [ Param.make "angleInRadians" TFloat "" ]
      returnType = TFloat
      description = "Returns the tangent of the given `angleInRadians`.
    ...
    { name = fn "Math" "acos" 0
      ...
      description = "Returns the arc cosine of `ratio`, as an Option.
    ...
    { name = fn "Math" "asin" 0
      parameters = [ Param.make "ratio" TFloat "" ]
      returnType = TOption varA
      description = "Returns the arc sine of `ratio`, as an Option.
         If `ratio` is in the inclusive range `[-1.0, 1.0]`, returns
    ...
    { name = fn "Math" "atan" 0
      parameters = [ Param.make "ratio" TFloat "" ]
      returnType = TFloat
      description = "Returns the arc tangent of `ratio`. The result is in radians and is between `-Math::pi/2` and `Math::pi/2`.
    ...
    { name = fn "Math" "atan2" 0
      ...
      returnType = TFloat
      description = "Returns the arc tangent of `y / x`, using the signs of `y` and `x` to determine the quadrant of the result.
