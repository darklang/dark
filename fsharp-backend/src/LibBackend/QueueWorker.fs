...
// let dequeueAndProcess (executionID : id) :
//     Result<Option<RT.Dval>, Exception.captured> =
//   Telemetry.with_root
//     "dequeue_and_process"
...
//                           ; ("host", `String host)
//                           ; ("event_id", `String (string_of_int event.id))
//                           ; ("handler_id", `String (Types.string_of_id h.tlid))
//                           ] ;
//
...
//                         Span.set_attrs
//                           parent
//                           [ ("result_tipe", `String (result_tipe result))
...
//                     let bt = Exception.get_backtrace () in
//                     ignore
//                       ( try Event_queue.put_back transaction event ~status:`Err
//                         with e ->
//                           Span.set_attr
//                             parent
//                             "error.msg"
//                             (`String (Libexecution.Exception.exn_to_string e))
//                       ) ;
//                     let log_params =
//                       List.append
