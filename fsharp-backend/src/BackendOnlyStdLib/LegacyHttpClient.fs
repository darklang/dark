module BackendOnlyStdLib.LegacyLibHttp
  ...
  let rec httpCall
    ...
    task {
      ...
      if (count > 50) then
        ...
        let! response =
          makeHttpCall rawBytes url queryParams method reqHeaders reqBody
