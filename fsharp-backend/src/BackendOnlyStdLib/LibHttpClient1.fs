...
let fns : List<BuiltInFn> =
  [ { name = fn "HttpClient" "post" 1
      ...
      description = "Make blocking HTTP POST call to <param uri>"
    ...
    { name = fn "HttpClient" "put" 1
      parameters = parameters
      returnType = returnType
      description = "Make blocking HTTP PUT call to <param uri>"
    ...
    { name = fn "HttpClient" "get" 1
      ...
      returnType = returnType
      description = "Make blocking HTTP GET call to <param uri>"
    ...
    { name = fn "HttpClient" "delete" 1
      parameters = parametersNoBody
      returnType = returnType
      description = "Make blocking HTTP DELETE call to <param uri>"
    ...
    { name = fn "HttpClient" "options" 1
      parameters = parametersNoBody
      returnType = returnType
      description = "Make blocking HTTP OPTIONS call to <param uri>"
    ...
    { name = fn "HttpClient" "head" 1
      parameters = parametersNoBody
      returnType = returnType
      description = "Make blocking HTTP HEAD call to <param uri>"
    ...
    { name = fn "HttpClient" "patch" 1
      parameters = parameters
      returnType = returnType
      description = "Make blocking HTTP PATCH call to <param uri>"
