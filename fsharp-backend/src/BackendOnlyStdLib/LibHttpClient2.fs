...
let fns : List<BuiltInFn> =
  [ { name = fn "HttpClient" "post" 2
      ...
      description =
        "Make blocking HTTP POST call to <param uri>. Returns a <type Result> where <code Ok> is a response <type Dict> if successful and <code Error> is an error message if not successful"
    ...
    { name = fn "HttpClient" "put" 2
      ...
      returnType = returnType
      description =
        "Make blocking HTTP PUT call to <param uri>. Returns a <type Result> where <code Ok> is a response <type Dict> if successful and <code Error> is an error message if not successful"
    ...
    { name = fn "HttpClient" "get" 2
      ...
      returnType = returnType
      description =
        "Make blocking HTTP GET call to <param uri>. Returns a <type Result> where <code Ok> is a response <type Dict> if successful and <code Error> is an error message if not successful"
    ...
    { name = fn "HttpClient" "delete" 2
      ...
      returnType = returnType
      description =
        "Make blocking HTTP DELETE call to <param uri>. Returns a <type Result> where <code Ok> is a response <type Dict> if successful and <code Error> is an error message if not successful"
    ...
    { name = fn "HttpClient" "options" 2
      ...
      returnType = returnType
      description =
        "Make blocking HTTP OPTIONS call to <param uri>. Returns a <type Result> where <code Ok> is a response <type Dict> if successful and <code Error> is an error message if not successful"
    ...
    { name = fn "HttpClient" "head" 2
      ...
      returnType = returnType
      description =
        "Make blocking HTTP HEAD call to <param uri>. Returns a <type Result> where <code Ok> is a response <type Dict> if successful and <code Error> is an error message if not successful"
    ...
    { name = fn "HttpClient" "patch" 2
      ...
      returnType = returnType
      description =
        "Make blocking HTTP PATCH call to <param uri>. Returns a <type Result> where <code Ok> is a response <type Dict> if successful and <code Error> is an error message if not successful"
