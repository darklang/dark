module LibExecution.LibString.Tests
...
let tests =
  testList
    "LibString"
    [ t "String::length_v0 \"กำ\" = 2"; t "String::length_v1 \"กำ\" = 1" ]
(* tfn2 *)
(*    "String::length returns the correct length for a string containing an emoji" *)
(*    "String" *)
(*    "length" *)
(*    [ str "👨‍👩‍👧‍👦" ] *)
(*    (Dval.int 7, Dval.int 1) ] *)
(* tfn2 *)
(*   "String::length_v0 works for Thai" *)
(*   "String" *)
(*   "length" *)
(*   [ str "กำ" ] *)
(*   (Dval.int 2, Dval.int 1) *)
(* tfn2 *)
(*   "String::length returns the correct length for a string containing an emoji" *)
(*   (fn "String" "length" 0 [ str "👨‍👩‍👧‍👦" ] *)
(*   String::length_v0 "5" = 7 *)
(*   (Dval.int 7, Dval.int 1) *)
(* tfn2 *)
(*  *)
...
(*   ; ("String trim noops",  t_string_trim_noop) *)
(*   ; ("String trim empties a whitespace only string",  t_string_trim_all) *)
(*   ; ("String trims leading spaces",  t_string_trim_left_trivial) *)
(*   ; ("String trims trailing spaces",  t_string_trim_right_trivial) *)
...
(*   ; ("HTML escaping works reasonably",  t_html_escaping) *)
(*   ; ("UUIDs round-trip to/from strings",  t_uuid_string_roundtrip) *)
(*   ; ("Slugify works",  t_slugify_works) *)
(*   ; ("substring works",  t_substring_works) *)
(*   ; ("startsWith works",  t_startsWith_works) *)
(*   ; ("endsWith works",  t_endsWith_works) *)
(*   ; ("string_toint_works",  t_toint_works) *)
...
(*   ; ("String::toList_v1 works",  t_toList_v1_works) ] *)
(*  *)
